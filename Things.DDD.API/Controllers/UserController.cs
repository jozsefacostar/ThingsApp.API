...
namespace Things.DDD.API.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public async Task<PetitionResponse> Login(UserLoginCommand GameCreateCommand)
        {
        ...
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<PetitionResponse> Logout(UserLogoutCommand GameCreateCommand)
        {
            return await _mediator.Send(GameCreateCommand);
        }
        #endregion
